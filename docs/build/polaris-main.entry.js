import { r as registerInstance, h, c as getElement } from './core-cda6bd5a.js';
...
const PolarisMain = class {
    ...
    render() {
        return h("div", { id: "mainContent" }, h("polaris-workflow", { id: "mainWf", process: this.process, activity: this.activity, sessionId: this.sessionId }));
    }
    setProcess() {
