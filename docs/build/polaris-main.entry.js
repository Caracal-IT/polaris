import { r as registerInstance, h, c as getElement } from './core-cfeeaf49.js';
...
const PolarisMain = class {
    ...
    componentDidLoad() {
        const wf = this.el.querySelector("#mainWf");
        if (wf)
            wf.setServices(this.ctx);
    }
    render() {
        return h("div", { id: "mainContent" }, h("polaris-workflow", { parent: this.ctx, id: "mainWf", process: this.process, activity: this.activity, sessionId: this.sessionId }));
    }
    setProcess() {
