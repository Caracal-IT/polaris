...
System.register([], function (exports, module) {
    ...
    return {
        execute: function () {
            ...
            var H = (win.HTMLElement || /** @class */ (function () {
            ...
            var IS_NODE_ENV = typeof global !== 'undefined' &&
                typeof require === 'function' &&
                !!global.process &&
                Array.isArray(global.process.argv) &&
                typeof __filename === 'string' &&
                (!global.origin || typeof global.origin !== 'string');
            var IS_NODE_WINDOWS_ENV = IS_NODE_ENV && global.process.platform === 'win32';
            ...
            var emitEvent = function (elm, name, opts) {
                var ev = new (BUILD.hydrateServerSide ? win.CustomEvent : CustomEvent)(name, opts);
            ...
            var scheduleUpdate = function (hostRef, isInitialLoad) {
                ...
                return then(promise, BUILD.taskQueue ? function () { return writeTask(update); } : update);
            };
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 4:
                            ...
                            return [4 /*yield*/, module.import('./shadow-css-97961c62.system.js').then(function (m) { return m.scopeCss(style_1, scopeId_1, false); })];
                        case 5:
                            style_1 = _a.sent();
                            _a.label = 6;
                        case 6:
            ...
            var forceModeUpdate = function (elm) {
                if (BUILD.style && BUILD.mode && !BUILD.lazyLoad) {
                    ...
                    if (hostRef.$modeName$ !== mode) {
                        ...
                        var scopeId_3 = getScopeId(cmpMeta.$tagName$, mode);
            ...
            var patchChildSlotNodes = function (elm, cmpMeta) {
                if (cmpMeta.$flags$ & 8 /* needsShadowDomShim */) {
                    var childrenFn_1 = elm.__lookupGetter__('children');
                    var childNodesFn_1 = elm.__lookupGetter__('childNodes');
                    Object.defineProperty(elm, 'children', {
                        get: function () {
                            var children = childrenFn_1.call(this);
                            if ((plt.$flags$ & 1 /* isTmpDisconnected */) === 0) {
                                var slotNode = getHostSlotNode(children, '');
                    ...
                    Object.defineProperty(elm, 'childNodes', {
                        get: function () {
                            ...
                            if ((plt.$flags$ & 1 /* isTmpDisconnected */) === 0) {
                                var slotNode = getHostSlotNode(childNodes, '');
                                if (slotNode && slotNode.parentNode) {
            ...
            var insertVdomAnnotations = function (doc) {
                if (doc != null) {
                    ...
                    orgLocationNodes.map(function (orgLocationNode) {
            ...
            var insertVNodeAnnotations = function (doc, hostElm, vnode, docData, cmpData) {
                if (vnode != null) {
                    ...
                    if (vnode.$children$ != null) {
                        var depth_1 = 0;
                        vnode.$children$.map(function (vnodeChild, index) {
            ...
            var insertChildVNodeAnnotations = function (doc, vnodeChild, cmpData, hostId, depth, index) {
                ...
                if (vnodeChild.$children$ != null) {
                    ...
                    vnodeChild.$children$.map(function (vnode, index) {
            ...
            var loadModule = function (cmpMeta, hostRef, hmrVersionId) {
                ...
                var bundleId = (BUILD.mode && typeof cmpMeta.$lazyBundleIds$ !== 'string' ? cmpMeta.$lazyBundleIds$[hostRef.$modeName$] : cmpMeta.$lazyBundleIds$);
            ...
            var consume = function (queue) {
                for (var i_7 = 0; i_7 < queue.length; i_7++) {
                    try {
                        queue[i_7](performance.now());
                    }
                    catch (e) {
                        consoleError(e);
                    }
            ...
            var patchEsm = exports('a', function () {
                ...
                if (BUILD.cssVarShim && !(CSS && CSS.supports && CSS.supports('color', 'var(--c)'))) {
                    // @ts-ignore
                    return module.import(/* webpackChunkName: "stencil-polyfills-css-shim" */ './css-shim-e65ef8bd.system.js').then(function () {
            ...
            var patchBrowser = exports('p', function () {
                ...
                if (!BUILD.safari10 && importMeta !== '') {
                    ...
                    if (BUILD.dynamicImportShim && !win.customElements) {
                        ...
                        // @ts-ignore
                        return module.import(/* webpackChunkName: "stencil-polyfills-dom" */ './dom-5df17823.system.js').then(function () { return opts; });
                    }
                }
            ...
            var patchCloneNodeFix = function (HTMLElementPrototype) {
                ...
                HTMLElementPrototype.cloneNode = function (deep) {
                    ...
                    if (deep) {
                        for (var i_8 = 0; i_8 < srcChildNodes.length; i_8++) {
                            // Node.ATTRIBUTE_NODE === 2, and checking because IE11
                            if (srcChildNodes[i_8].nodeType !== 2) {
                                clonedNode.appendChild(srcChildNodes[i_8].cloneNode(true));
                            }
                        }
                    }
                    return clonedNode;
